...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="{{ asset('/build/beike/shop/fashion5/css/bootstrap.css') }}">
  ...
  <script src="{{ asset('/build/beike/shop/fashion5/js/app.js') }}"></script>
  <link rel="stylesheet" type="text/css" href="{{ asset('/build/beike/shop/fashion5/css/app.css') }}">
