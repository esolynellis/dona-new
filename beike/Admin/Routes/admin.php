    ...
    ->group(function () {
        ...
        Route::middleware('admin_auth:' . \Beike\Models\AdminUser::AUTH_GUARD)
            ->group(function () {
                ...
                // 慧批商品分类
                Route::middleware('can:huipi_sites_index')->get('huipi_sites', [Controllers\HuipiSiteController::class, 'index'])->name('huipi_sites.index');
                // 慧批商品
                Route::middleware('can:huipi_goods_index')->get('huipi_goods', [Controllers\HuipiGoodsController::class, 'index'])->name('huipi_goods.index');
