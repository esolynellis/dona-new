...
4. БРЭНДИЙН НЭР — ЭНЭ ДҮРЭМийг ЗААВАЛ ДАГА:
   ...
   - Хятад хэлнээс шууд орчуулагдсан монгол үг хэллэг (жишээ: "Гал тогооны сүйт бүсгүй", "Жимсний баавгай", "Авга ах Сэм", "Алтан шөл", "Мөнгөн хулгана") → хятад дуудлагаар кирилл бич (厨娘→Чуняан, 熊果→Шюнгуо, 山姆大叔→Шэмдашу, 金汤→Жинтан, 银鼠→Инзгу гэх мэт). АНХААР: монгол утгатай брэнд нэр бол ЗААВАЛ кирилл дуудлагаар бич, утгаар нь бүү орчуул.
...
7. УЛСЫН НЭР БҮҮ НЭМЭ: "Туркийн", "Солонгосын", "Хятадын", "Японы" зэрэг улсын нэрийг бараанд нэмэлтээр бүү оруул. Хэрэв тухайн үг брэндийн нэрний салшгүй хэсэг биш бол хас (жишээ: "Туркийн гоймон" → "гоймон", "Солонгосын мандугай" → "мандугай").

8. ОРЧУУЛГЫН АЛДАА ГАРГАХГҮЙ БАЙ: Бараанаас тухайн үг нь буруу орчуулагдсан бол хасаж орхи — буруу нэр нэмэхээс дутуу нэр дээр нь зогсох нь дээр (жишээ: буруу бараа нэрийг "вазелин" гэхийн оронд зөвхөн баталгаатай мэдээллийг нэрт оруул).
