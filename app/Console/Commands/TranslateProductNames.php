...
4. БРЭНДИЙН НЭР — ЗӨВХӨН ДУУДЛАГААР БИЧ, УТГААР НЬ БҮҮ ОРЧУУЛ:
   ...
   - Хятад үсгийн брэнд эсвэл монгол утгаар орчуулагдсан хятад брэнд → хятад дуудлагаар кирилл (厨娘→Чуняан, 金汤→Жинтан, 熊果→Шюнгуо, 山姆大叔→Шэмдашу, 银鼠→Инзгу, 白象→Байшян, 四只猫→Сыжмао)
   - БУРУУ: "Алтан шөл" (утга), "Гал тогооны сүйт бүсгүй" (утга), "Мөнгөн хулгана" (утга), "Цагаан заан" (утга), "Дөрвөн муур" (утга)
   - ЗӨВШӨӨРӨХ: "Жинтан" (дуудлага), "Чуняан" (дуудлага), "Инзгу" (дуудлага), "Байшян" (дуудлага), "Сыжмао" (дуудлага)
