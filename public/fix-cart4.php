...
/* Mobile: нэг мөрт, нарийн */
@media(max-width:480px){
  .product-wrap .image .button-wrap{display:flex!important;bottom:0!important;opacity:1!important;height:28px!important;}
  ...
  .product-wrap .image .button-wrap .btn-wish{
    flex:0 0 28px!important;min-height:28px!important;height:28px!important;
...
echo json_encode(['done'=>true,'mobile_height'=>'28px','ts'=>time()]);
